module MuseumProvenance
  ...
  class Provenance
    ...
    ABBREVIATIONS  = ["Mme.", "Mr.", "Mrs.", "Dr.", "no.", "No.", "Esq.", "Co.", "St.", "illus.", "inc.", "Inc.", "Jr.", "Ltd.", "Dept.", "M.","P."]
    # A list of name suffixes.  A "," preceding any of these will not signify the end of a name.
    NAME_EXTENDERS = ["Jr", "Count", "Earl", "Inc.", "Ltd.", "Lord", "MP", "M.P.", "2nd", "son of", "daughter of", "wife of", "husband of", "the artist", "his wife", "his nephew", "his son", "his daughter"]
